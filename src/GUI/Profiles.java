...
public class Profiles {
    public Scene profileList(Stage stage, String email){
        ...
        for (Profile profile: profileList) {
            ...
            btnWatchedPreviously.setOnAction(e -> stage.setScene(new Profiles().watchedList(stage, profile.getProfileId())));
    ...
    public Scene watchedList(Stage stage, int profileId) {
        AnchorPane mainPane = new AnchorPane();
        mainPane.prefHeight(800.0);
        mainPane.prefWidth(1600.0);
        mainPane.setStyle("-fx-background-color: #545454;");
